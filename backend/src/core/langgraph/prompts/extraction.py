...
NOTE: Some prompts in this file have been deprecated as of 2026-01-22.
- BRIEF_ROOM_SUMMARY_PROMPT - Now part of comprehensive_analysis.py
- FEATURES_TO_RETAIN_PROMPT - Now part of comprehensive_analysis.py

The comprehensive analysis extracts all this data in a single VLM call.
See: comprehensive_analysis.py for the consolidated prompt.
"""

# =============================================================================
# ACTIVE PROMPTS - Still in use
# =============================================================================
...
# =============================================================================
# DEPRECATED PROMPTS - Commented out, now part of comprehensive_analysis.py
# =============================================================================

# BRIEF_ROOM_SUMMARY_PROMPT = """Analyze this room image and provide a brief, conversational summary.
#
# DEPRECATED: Now part of comprehensive_analysis.py
# The summary is extracted as:
#     comprehensive_result["summary"]["brief_description"]
#     comprehensive_result["summary"]["room_vibe"]
#
...
#
# DEPRECATED: Now part of comprehensive_analysis.py
# This data is extracted as:
#     comprehensive_result["visible_elements"]
#     comprehensive_result["image_scope"]
#     comprehensive_result["must_not_add"]
#     comprehensive_result["features_to_retain"]
#
