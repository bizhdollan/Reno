...
Handles image analysis using VLM, including:
- Feature extraction (materials, colors, measurements)
- Critical element detection (windows, doors, structural features)
- Room type classification
- Multi-perspective conflict detection
...
class ImageAnalysisService:
    ...
    - Extract features (materials, colors, measurements)
    - Detect critical elements (windows, doors, structural)
    ...
    async def extract_critical_elements(
        ...
        Returns:
            ...
            {
                "windows": {"count": 2, "wall": "east", "confidence": 0.9},
                "doors": {"count": 1, "wall": "north", "confidence": 0.85},
                ...
            }
        """
